...
public class PartA {
	public static void main(String[] args) {
		...
		angleA = Math.toDegrees(Math.asin(height/hypotenuse));
		angleB = Math.toDegrees(Math.asin(base/hypotenuse));
		angleC = 90.00;
		
		System.out.printf(
				 triangle, 
				 twoDForm.format(hypotenuse), 
				 twoDForm.format(height), 
				 twoDForm.format(base));
